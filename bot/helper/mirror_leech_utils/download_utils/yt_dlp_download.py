...
class YoutubeDLHelper:
    def __init__(self, listener):
        ...
        self.opts = {
            ...
            # Force the use of aria2c with arguments
    ...
    def extractMetaData(self, link, name):
        # Set aria2c as the external downloader for all cases
        self.opts["external_downloader"] = "aria2c"
        self.opts["external_downloader_args"] = ["-x", "16", "-s", "16"]
